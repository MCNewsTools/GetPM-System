...
$info = file_get_contents('https://getpm.reh.tw/api/channel/json.php?channel=ClearSky&type=1');
$json_decode = json_decode($info, true);
?>
<html><head>
    <meta name="og:description" content="多 PocketMine 核心下載 For Minecraft 資訊工具網">
    <meta property="og:title" content="ClearSky | PocketMine Downloads - Minecraft 資訊工具網">
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://getpm.reh.tw/page/clearsky/">
    ...
    <title>ClearSky | PocketMine Downloads - Minecraft 資訊工具網</title>
    <meta charset="utf-8">
    ...
    <div class="section section-warning">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <a class="btn btn-primary" href="<?php echo $json_decode['download_url']; ?>"><?php echo '下載 ClearSky_'.$json_decode['version'].'-'.$json_decode['build'].'_API-'.$json_decode['api_version'].'.phar'; ?></a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <pre>wget -q -O - https://getpm.reh.tw/en-US/ | bash -s - -v ClearSky</pre>
            <pre>curl -sL https://getpm.reh.tw/en-US/ | bash -s - -v ClearSky</pre>
            <br>
            <p class="lead">
              <b>繁體中文</b>
            </p>
            <pre>wget -q -O - https://getpm.reh.tw/zh-TW/ | bash -s - -v ClearSky</pre>
            <pre>curl -sL https://getpm.reh.tw/zh-TW/ | bash -s - -v ClearSky</pre>
            <br>
            <p class="lead">
              <b>简体中文</b>
            </p>
            <pre>wget -q -O - https://getpm.reh.tw/zh-CN/ | bash -s - -v ClearSky</pre>
            <pre>curl -sL https://getpm.reh.tw/zh-CN/ | bash -s - -v ClearSky</pre>
          </div>
        </div>
      </div>
    </div>
