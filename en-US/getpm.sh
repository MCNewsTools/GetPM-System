...
wget -q -O - https://getpm.reh.tw/en-US/php7/ | bash
wget -q -O - https://getpm.reh.tw/en-US/php5/ | bash
rm compile.sh
...
echo -n " system is"
printf "\33[0;92m"
echo -n " Minecraft News Tools Website"
printf "\33[0m"
echo -n " Its system, by"
printf "\33[0;93m"
echo -n " 旋風之音 (GoneTone)"
printf "\33[0m"
echo -n " (and other friends) development."
echo " "
...
printf "\33[0;93m"
echo ">>> Minecraft News Tools Website <<<"
printf "\33[0m"
echo -n "website:"
printf "\33[0;92m"
